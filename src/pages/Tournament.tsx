...
const Tournament = () => {
    ...
    const fetchData = async () => {
        const { data } = await axios
            .get('https://line04w.bk6bba-resources.com/line/desktop/topEvents3?place=live&sysId=1&lang=ru&salt=2o9hzyrwfmwl9cnms46&scopeMarket=1600');
        setItems(data);
    };

    const filterEvents = () => {
        const filteredArr: Event[] = [];
        if (items) {
            ...
            <div className={styles.content}>
                <div className={styles.tournamentInfo}>
                    <h2 className={styles.listHeading}>
                        Турнир The International 2022 по Dota 2
                    </h2>
                    ...
                    <div className={styles.tournament}>
                        ...
                        <div className={styles.tournamentText}>
                            <p className={styles.text}>
                                Дата начала:
                                {' '}
                                <span className={styles.span}>15 Окт 2022</span>
                            </p>
                            <p className={styles.text}>
                                Дата завершения:
                                {' '}
                                <span className={styles.span}>30 Окт 2022</span>
                            </p>
                        </div>
                    </div>
                    <div className={styles.textBlock}>
                        <p>
                            Осенью этого года состоится важный киберспортивный турнир, даты начала и завершения основной
                            ...
                            корпорация Valve &ndash; разработчик и издатель видеоигр.
                        </p>

                        <h2>Формат, условия участия</h2>

                        <p>
                            В турнире по Дота international 2022 примут участие два десятка команд, но пройти в финал
                        ...
                        <ol>
                            <li>
                                Квалификация (8-12). Сыграют вторые и третьи места первенств регионов &ndash; дюжина
                                коллективов, между которыми будут распределены два входа.
                            </li>
                            <li>
                                Групповой этап (15-18). Пройдут матчи с участием двенадцати клубов-победителей
                        ...
                        <p>
                            По итогам групповой части четыре слабейшие команды покинут состязание, восемь лучших попадут
                            в верхнюю сетку плей-офф и сразятся за титул победителя турнира (29-30), остальные
                            встретятся в борьбе за почетные места.
                        </p>

                        <p>
                            Важное условие. Вышедшие в групповой этап 20 коллективов поделят на две равные подгруппы.
                        ...
                        <p>
                            Рассматриваемое событие считается крупнейшим среди ежегодных киберспортивных турниров.
                        ...
                        <p>
                            Интересный факт. На чемпионат могла попасть российская команда Virtus.pro, но оказалась за
                            ...
                            международным, с офисом в Белграде.
                        </p>
                        ...
                        <p>
                            При этом отсутствуют представители Ближнего Востока, Африки, Австралии и Океании.
                                ...
                                topEvents.length > 0 ? topEvents.map((item) => (
                                    <li className={styles.scheduleItem} key={item.id}>
                                        <p className={styles.itemTime}>
                                            ...
                                            {monthConverter(new Date().getMonth())}
                                            {' '}
                                            в
                                            {unixTimeStampConverterToTime(item.startTimeTimestamp)}
                                        </p>
                    ...
                    <h2 className={styles.listHeadingTeams}>
                        Составы команд
                    </h2>
                    <div className={styles.separator} />
                    <div className={styles.teams}>
                        ...
                        {open && <Roasters lazy isOpen={open} />}
                    </div>
                    <div className={styles.results}>
                        ...
                        <div className={styles.table}>
                            <div className={styles.tableRow}>
                                ...
                                <div className={styles.column}>
                                    <p className={styles.text}>
                                        <img src={tundra} alt="Tundra" className={styles.teamImage} />
                                        {' '}
                                        Tundra Esports
                                    </p>
                                </div>
                            ...
                            <div className={styles.tableRow}>
                                ...
                                <div className={styles.column}>
                                    <p className={styles.text}>
                                        <img src={secret} alt="Secret" className={styles.teamImage} />
                                        {' '}
                                        Team Secret
                                    </p>
                                </div>
                            ...
                            <div className={styles.tableRow}>
                                ...
                                <div className={styles.column}>
                                    <p className={styles.text}>
                                        <img src={liquid} alt="Liquid" className={styles.teamImage} />
                                        {' '}
                                        Team Liquid
                                    </p>
                                </div>
                            ...
                            <div className={styles.tableRow}>
                                ...
                                <div className={styles.column}>
                                    <p className={styles.text}>
                                        <img src={aster} alt="Aster" className={styles.teamImage} />
                                        {' '}
                                        Team Aster
                                    </p>
                                </div>
                            ...
                            {visible && <Results lazy isOpen={visible} />}
                        </div>
                                ...
                                <div className={styles.wrapperSecond}>
                                    ...
                                    <div className={styles.tournamentTable}>
                                        ...
                                        <div className={styles.columnAnother}>
                                            ...
                                            <TournamentMatch
                                                team1Name="beastcoast"
                                                team1Logo={beastcoast}
                                                team1Score={1}
                                                team2Score={2}
                                                team2Logo={psg}
                                                team2Name="PSG.LGD"
                        ...
                        <a
                            href="https://promote.betcity.ru/freebet500app/"
                            target="_blank"
