...
const Matches = () => {
    ...
    return (
        <Layout
            seoDescription="The International 2022 по Dota 2: расписание матчей по турниру International 11"
        ...
        >
            <div className={styles.calendar}>
                ...
                <div className={styles.calendarDateSlider}>
                    <button type="button" className={styles.button} onClick={prevHandler}>
                        <img
                            src={drop}
                            alt="dropDownIcon"
                    ...
                    <button type="button" className={styles.button} onClick={nextHandler}>
                        <img
                            src={drop}
                            alt="dropDownIcon"
