            ...
            <div className={styles.footerContainer}>
                <div className={styles.upWrap}>
                    <div className={styles.logo}>
                        ...
                        <div className={styles.text}>
                            <h2 className={styles.logoText}>
                                Dota
                                <span className={styles.logoSpan}>2</span>
                            </h2>
                    ...
                    <div className={styles.socials}>
                        <div className={styles.socialYou}>
                            <img
                                src={youtube}
                                alt="YouTube"
                        ...
                        <div className={styles.socialTwitch}>
                            <img
                                src={twitch}
                                alt="Twitch"
                                className={styles.socialImg}
                ...
                <div className={styles.footerDownDown}>
                    ...
                    <p className={styles.footerText}>
                        ...
                        Cum et eum quaerat quasi sed similique!
                    </p>
