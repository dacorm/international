    ...
    return (
        <>
            <div className={styles.tableRow}>
                ...
                <div className={styles.column}>
                    <p className={styles.text}>
                        <img src={psg} alt="PSG" className={styles.teamImage} />
                        {' '}
                        PSG.LGD,
                    </p>
                    <p className={styles.text}>
                        <img src={thunder} alt="Thunder" className={styles.teamImage} />
                        {' '}
                        Thunder
                        Awaken
                    </p>
            ...
            <div className={styles.tableRow}>
                ...
                <div className={styles.column}>
                    <p className={styles.text}>
                        <img src={og} alt="OG" className={styles.teamImage} />
                        {' '}
                        OG
                    </p>
                    <p className={styles.text}>
            ...
            <div className={styles.tableRow}>
                ...
                <div className={styles.column}>
                    <p className={styles.text}>
                        <img src={boom} alt="Boom" className={styles.teamImage} />
                        {' '}
                        Boom Esports,
                    </p>
                    <p className={styles.text}>
                        <img src={gladiators} alt="Gladiators" className={styles.teamImage} />
                        {' '}
                        Gaimin
                        Gladiators,
                    </p>
                    <p className={styles.text}>
                        <img src={eg} alt="Evil Geniuses" className={styles.teamImage} />
                        {' '}
                        Evil
                        Geniuses,
                    </p>
                    <p className={styles.text}>
                        <img src={entity} alt="Entity" className={styles.teamImage} />
                        {' '}
                        Entity Gaming
                    </p>
                </div>
            ...
            <div className={styles.tableRow}>
                ...
                <div className={styles.column}>
                    <p className={styles.text}>
                        <img src={spirit} alt="Team Spirit" className={styles.teamImage} />
                        {' '}
                        Team
                        Spirit,
                    </p>
                    <p className={styles.text}>
                        <img src={fnatic} alt="Fnatic" className={styles.teamImage} />
                        {' '}
                        Fnatic,
                    </p>
                    <p className={styles.text}>
                        <img src={hokori} alt="Hokori" className={styles.teamImage} />
                        {' '}
                        Hokori,
                    </p>
                    <p className={styles.text}>
                        <img src={rng} alt="RNG" className={styles.teamImage} />
                        {' '}
                        Royal Never Give Up
                    </p>
                </div>
            ...
            <div className={styles.tableRow}>
                ...
                <div className={styles.column}>
                    <p className={styles.text}>
                        <img src={soniqs} alt="Soniqs" className={styles.teamImage} />
                        {' '}
                        Soniqs,
                    </p>
                    <p className={styles.text}>
                        <img src={talon} alt="Talon" className={styles.teamImage} />
                        {' '}
                        Talon Esports
                    </p>
                </div>
            ...
            <div className={styles.tableRow}>
                ...
                <div className={styles.column}>
                    <p className={styles.text}>
                        <img src={tsm} alt="TSM" className={styles.teamImage} />
                        {' '}
                        TSM,
                    </p>
                    <p className={styles.text}>
                        <img src={betboom} alt="BetBoom" className={styles.teamImage} />
                        {' '}
                        BetBoom Team
                    </p>
                </div>
