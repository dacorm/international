        ...
        <>
            <ul className={styles.teamsTable}>
                ...
                <li className={styles.teamMember}>
                    ...
                    <p className={styles.memberText}>Ду <span
                        className={styles.memberSpan}>Monet</span> Пн</p>
                </li>
                <li className={styles.teamMember}>
                    <img src={cn} alt="Флаг" className={styles.memberFlag}/>
                    <p className={styles.memberText}>Цзэн <span
                        className={styles.memberSpan}>Ori</span> Цзяоян</p>
                </li>
                <li className={styles.teamMember}>
                    <img src={cn} alt="Флаг" className={styles.memberFlag}/>
                    <p className={styles.memberText}>Лин <span
                        className={styles.memberSpan}>Xxs</span> Дзин</p>
                </li>
                <li className={styles.teamMember}>
                    <img src={cn} alt="Флаг" className={styles.memberFlag}/>
                    <p className={styles.memberText}>Е <span
                        className={styles.memberSpan}>BoBoKa</span> Джибяо</p>
                </li>
                <li className={styles.teamMember}>
                    <img src={cn} alt="Флаг" className={styles.memberFlag}/>
                    <p className={styles.memberText}>Ю <span
                        className={styles.memberSpan}>Fantasy</span> Яюнь</p>
                </li>
